...
export default function UserDashboard() {
  ...
  const handleOpenProfile = async () => {
    ...
    try {
        ...
        setEditName(profileRes.data.user?.profile?.name || "");
        setEditMobile(profileRes.data.user?.profile?.mobile || "");
  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', zIndex: 0, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
                 ...
                 <div style={{ marginTop: '10px' }}>
                     <div style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <div style={{ overflow: 'hidden' }}>
                            ...
                            <div style={{ fontSize: '13px', color: '#aaa', marginTop: '4px' }}>📞 {userProfile.profile?.mobile}</div>
                        </div>
                     </div>
         ...
         {/* History Render (Only visible in profile mode) */}
         {viewMode === "profile" && (
